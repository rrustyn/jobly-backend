...
ALTER TABLE ONLY public.jobs DROP CONSTRAINT jobs_company_handle_fkey;
ALTER TABLE ONLY public.applications DROP CONSTRAINT applications_username_fkey;
ALTER TABLE ONLY public.applications DROP CONSTRAINT applications_job_id_fkey;
...
test	$2b$12$uApZGdidZpOzNmZPdxohvOSP23oT2JX4rhdemWXEC/dsBHYzbbKby	test	mcTest	test@email.com	f
password	$2b$12$QnIONMBUghsWfCcQgn30t.yNJyEAyxoUpcP17IcA4Yopqte3ZItqC	cool	guy	test@test.com	f
islandboy	$2b$12$HZIikP5cjqzWbwqCwmMC7uMMXJYOxtRNIPKLfLcftwAhOEmJEurZe	hakeem	best	kadeem@best.com	f
\.
